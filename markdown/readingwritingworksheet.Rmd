...
```{r}
# data file: WCSweatherdays2000s.txt
...
Delimited is generally defined as "having fixed boundaries or limits". A delimited file is a file with columns separated by delimiters (other than white space). Two common delimiters are commas and tabs (\t in `R`). Character data may or may not be enclosed in quotes.
